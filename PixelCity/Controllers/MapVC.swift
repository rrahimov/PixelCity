...
// when you create collection view programmatically you need to give a programmatic UICollectionView flow layout as well:
...
//        registerForPreviewing(with: self, sourceView: collectionView!)
    ...
    func addDoubleTap() {
        let doubleTap = UITapGestureRecognizer(target: self, action: #selector(dropPin(sender:))) // passes information from UITGS
...
extension MapVC: CLLocationManagerDelegate {
    ...
    func cancelAllSessions() {
        AF.session.getTasksWithCompletionHandler { (sessionDataTask, uploadData, downloadData) in
            ...
            //$0 is single line for loop (instead of "for task in")
        }
    }
}
...
//        popVC.initData(forImage: imageArray[indexPath.row])
//
//        UIContextMenuInteraction.fr = cell.contentView.frame
//        return popVC
//    }
